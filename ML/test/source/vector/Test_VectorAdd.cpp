...
void TestVectorAdd(const Vector& src1, const Vector& src2, Vector& dst)
{
...
void test::Test_VectorAdd(std::vector<int>& vec_len, float utilization, float threshold, float min, float max)
{
	HANDLE col_handle;
