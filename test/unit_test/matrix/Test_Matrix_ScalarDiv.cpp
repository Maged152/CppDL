...
struct MatrixScalarDiv : ::testing::TestWithParam<std::tuple<
    int,   // rows
	int,   // cols
...
TEST_P(MatrixScalarDiv, Test_MatrixScalarDiv)
{
...
INSTANTIATE_TEST_CASE_P(
    Test_MatrixScalarDiv, MatrixScalarDiv,
    ::testing::Combine(
